        ...
        <nav className="lp-nav" style={{ borderBottom:"1px solid #1e1e3f", backdropFilter:"blur(4px)", background:"rgba(10,10,15,0.6)" }}>
          ...
          <div className="lp-nav-links" style={{ fontSize:16 }}>
            ...
            <Link href="/play" style={{ padding:"8px 20px", background:"#7c3aed", color:"#fff", borderRadius:6, textDecoration:"none", fontWeight:"bold", fontSize:16, display:"inline-flex", alignItems:"center", gap:6 }}>
              <span style={{fontSize:"0.72em", lineHeight:1, marginTop:1}}>▶</span><span style={{position:"relative",top:1}}>{T('nav_play_demo')}</span>
            </Link>
          </div>
        </nav>
        ...
        <section className="lp-hero" style={{ maxWidth:1100, margin:"0 auto" }}>
          <div className="lp-hero-text">
            ...
            <div className="lp-hero-cta">
              ...
              }}><span style={{fontSize:"0.72em", lineHeight:1, marginTop:1}}>▶</span><span style={{position:"relative",top:1}}>{T('hero_cta_play')}</span></Link>
