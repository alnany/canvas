...
export const translations = {
  ...
  zh: {
    ...
    hero_tag:           '公平发行 · Solana · 总量 100 亿 $CANVAS',
    hero_sub1:          '像素战场，寸土必争。',
    hero_sub2:          '攻占格子，赚取 $CANVAS，乱局称王。',
    hero_desc:          '1000×1000 超大战场。实时 PVP 对抗。公平发行 — 无团队持仓，无 VC 分配。像素即领土，每一格都是战利品。',
    hero_cta_play:      '▶ 立即体验',
    hero_cta_how:       '游戏玩法 →',
    hero_pixels_placed: '演示战场已落子数',

    section_core_loop:  '玩法核心',
    section_how:        '游戏玩法',
    step1_label:        '落子占格',
    step1_desc:         '在 1000×1000 战场上任意格子落子。默认冷却 5 分钟，邀请好友或消耗 $CANVAS 可大幅缩短。',
    step2_label:        '赚取 $CANVAS',
    step2_desc:         '每次落子 +5 $CANVAS；持仓每格每小时 +0.5；随机爆击最高可得 200 倍大奖。',
    step3_label:        '烧币称霸',
    step3_desc:         '花费 $CANVAS 为你的领土开启 8 小时护盾。无护盾的格子随时可被对手吞并。',
    step4_label:        '拉人提速',
    step4_desc:         '每成功邀请一名玩家，冷却减少 30 秒，最多缩短 4 分钟，最快 1 分钟出手一次。',

    section_strikes:    '爆击大奖',
    strikes_desc:       '每次落子均有机会触发爆击，由链上随机数保障绝对公平，结果实时可验证。',
    strike_common:      '普通',
    strike_rare:        '稀有',
    strike_legendary:   '传奇',
    strike_chance:      '概率',
    strikes_ev:         '综合期望回报约 1.64 倍 — 链上公开透明，无任何后台操控。',

    section_tokenomics: '代币经济',
    tok_title:          '$CANVAS — 总量 100 亿枚',
    tok_gameplay:       '玩家奖励',
    tok_gameplay_sub:   '75 亿 — 落子奖励、持仓收益、爆击大奖',
    tok_lp:             'Raydium LP（已销毁）',
    tok_lp_sub:         '15 亿 — 与 SOL 配对，LP 代币已销毁',
    tok_dao:            'DAO 储备',
    tok_dao_sub:        '10 亿 — 社区活动、竞赛奖金、开发激励',
    ...
    cta_desc:           '直接在浏览器体验，无需钱包。',
    cta_btn:            '▶ 立即开战',

    footer_built:       '公平发行 · 链上透明 · 仅供体验 — 非投资建议',

    play_demo_note:     '1000×1000 战场 · 演示冷却 10 秒（正式版 5 分钟）· 无需钱包',
    play_connect:       '🔗 连接钱包',
    play_connecting:    '连接中…',
    ...
    shield_cost_sub:    '3 × {n} 格 · 正式版 8 小时 / 演示 30 秒',
    ...
    log_shield:         '[护盾] 激活 30 秒 · 费用：{n} $CANVAS',
